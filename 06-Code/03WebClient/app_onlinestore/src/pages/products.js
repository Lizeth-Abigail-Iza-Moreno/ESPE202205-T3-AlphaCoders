              ...
              <div class="card">
                ...
                <form class="form-card" >
                  <div class="row justify-content-center">
                    ...
                    <div class="row justify-content-center">
                      <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">
                        Talla<span class="text-danger"> *</span></label> <input type="number" id="txtTalla" name="txtTalla" />
                      </div>
                    </div>
                    <div class="row justify-content-center">
                      <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">
                        Precio<span class="text-danger"> *</span></label> <input type="number" id="txtPrecio" name="txtPrecio" />
                      </div>
                    </div>
                    <div class="row justify-content-center">
                      <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">
                        Stock:<span class="text-danger"> *</span></label> <input type="number" id="txtStock" name="txtStock" />
                      </div>
                    </div>
                  </div>
                  <br></br>
