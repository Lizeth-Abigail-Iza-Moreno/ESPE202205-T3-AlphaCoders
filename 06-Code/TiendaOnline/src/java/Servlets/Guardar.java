...
public class Guardar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean usuarioRepetido = metodos.buscarUsuarioRepetidoBD(txtCedula);

        if (usuarioRepetido == true) { //EL usuario ya esta registrado en la BD
            out.println("alert('¡Atencion!, El usuario con la cedula: " + txtCedula + ", Ya esta registrado en la BD')");
            out.println("location='index.html'");
        } else {
            
            boolean registro = metodos.registrarUsuario(txtCedula, txtNombre, txtApellidos, txtContrasena, txtUsuario);
